    ...
    return (
      <div className="homepage">
        ...
        <p className="aboutme">
          ...
          free time, I love to go hiking, camping, fishing as well as love to
          attend local meetups. I am available for fulltime employment and can
          start immediately. I am currently located in Atlanta, GA but willing
          to relocate.
        </p>
        <h1>Skills</h1>
        <p className="aboutme">
